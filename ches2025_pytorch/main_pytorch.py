...
if __name__=="__main__":
    ...
    for num_models in range(total_num_models):
        ...
        #Evaluate
        GE, NTGE = evaluate_fast(device, model, X_attack, plt_attack, correct_key,leakage_fn=leakage_fn, nb_attacks=100, total_nb_traces_attacks=100000, nb_traces_attacks=100000)
